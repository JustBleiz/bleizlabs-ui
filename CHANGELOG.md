...
- **`prepublishOnly` lint failure on `playwright-report/`.** When the
  ...
  ignore patterns so generated artifacts are never linted. v0.11.0
  shipped functionally identical to v0.11.1 but the npm publish step
  failed at this lint gate.
