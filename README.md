...
[![Version](https://img.shields.io/badge/npm-v0.7.4-0ea5e9)](https://github.com/BleizLabs/bleizlabs-ui/pkgs/npm/ui)
[![License](https://img.shields.io/badge/license-MIT-green)](LICENSE)
[![React](https://img.shields.io/badge/React-19-61dafb)](https://react.dev)
[![Next.js](https://img.shields.io/badge/Next.js-16.2-black)](https://nextjs.org)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.6-3178c6)](https://www.typescriptlang.org)

**Current version: [`@bleizlabs/ui@0.7.4`](https://github.com/BleizLabs/bleizlabs-ui/pkgs/npm/ui)** — patch release: seed-driven `--size-touch-min` semantic token (WCAG 2.1 SC 2.5.5) replacing 15 hardcoded `2.75rem` touch-min sites across `Calendar` / `Carousel` / `DatePicker` / `InputOTP` / `Slider` / `Toast`; 6 compact-control sites mapped to existing `var(--space-8)`; barrel comment + `package.json` description drift fixes; full README + CHANGELOG resync covering v0.5.9 → v0.7.4 surface (Display, Specialized, Molecules, Card presets, Composition presets all listed accurately). Visual output byte-equivalent — token resolves to identical `44px` / `32px` values. Consumer override paths: `@use '@bleizlabs/ui/styles' with ($seed-touch-target: 48px)` (build-time) or `:root { --size-touch-min: 48px; }` (runtime). Library ships **97 components across 10 categories**. Predecessor `v0.7.3` shipped `ZoneCard` (CP9) — Phase 8 Card-presets family completed at 10/10. See [CHANGELOG.md](CHANGELOG.md) for the full release history.
