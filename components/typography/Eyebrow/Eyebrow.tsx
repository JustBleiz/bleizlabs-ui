 ...
 * (Phase 2 atom, v0.5.4).
 *
 * Promoted from scout-hub `2026-04_e05-ui-polish` work-unit where the
 * pattern duplicated 5× across `batches.module.scss` (`.scopePreviewTitle`,
 * `.costHeroEyebrow`, `.costCapEyebrow`, `.formSectionEyebrow`, `.filterLabel`)
 ...
 *          14px hairline) are atelier-PRESENT vocabulary signatures,
 *          intentionally NOT tokenised — they define the eyebrow scale itself.
 * @deps    Slot (own primitive, asChild boundary), cn, React: `forwardRef`,
 *          types `HTMLAttributes<HTMLSpanElement>`, `ReactNode`
...
export interface EyebrowProps
  ...
  index?: number | string;
  /**
   * Color tier. Default `'muted'` (matches scout-hub eyebrow vocabulary).
