...
/**
 * ZoneCard — universal info card preset (server-safe).
 *
 * @tokens  Density mapping (token reuse via Card padding scale):
 ...
 *          via Text variant=caption. Tone colors: `--color-{success,
 ...
 * <ZoneCard ariaLabel="Indicators" title="Indicators">
 *   <p>Body content</p>
 * </ZoneCard>
 *
 * @example
 ...
 * <ZoneCard
 *   ariaLabel="Technical configuration"
 *   icon={<IconSettings size={14} stroke={2} aria-hidden="true" />}
 *   title="Configuration"
 *   subtitle="Production environment"
 *   rightSlot={<Badge color="success" dot label="Production" />}
 *   tone="success"
 * >
 *   <ul>...</ul>
 * </ZoneCard>
