...
/**
 * FormSurface — semantic form wrapper preset composing Card + slots.
 *
 * Renamed from `FormCard` in 0.13.0. The "Surface" suffix communicates the
 * structural role (a form-flavored Card surface) more clearly than "Card",
 * matching the naming canon in `library-charter.md` §"Universal Library —
 * Definition" (structural role names, no business prefix). `FormCard` remains
 * as a deprecated re-export through the 0.13.x cycle and will be removed in
 * 0.15.0 alongside the wider preset cleanup.
 *
 ...
 *          CardProps and redeclared on FormSurfaceProps so the preset owns their
 ...
 * @example
 * <FormSurface title="Account" description="Update your profile" onSubmit={handler}
...
export const FormSurface = forwardRef<HTMLElement, FormSurfaceProps>(
