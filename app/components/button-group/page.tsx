    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          Joined row or column of related buttons. Reuses the `joined-group` SCSS mixin — inner
          radii collapse, 1px borders dedupe, and focused / active children lift via z-index.
      ...
      <section className={styles.demo}>
        ...
        <Text variant="caption" color="muted">
          `orientation=&quot;vertical&quot;` stacks the buttons; the mixin collapses top/bottom
          inner radii instead of left/right.
        </Text>
        <div className={styles.row}>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">
          3. attached=false — gap-based
        </Heading>
        <Text variant="caption" color="muted">
          Falls back to a gapped row equivalent to `&lt;Inline gap=2&gt;`. Use when the group should
          look like discrete buttons instead of a unified surface.
        </Text>
        <div className={styles.row}>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">
          5. With icons (text glyph stand-ins)
        </Heading>
        <div className={styles.row}>
      ...
      <section className={styles.demo}>
        ...
        <Text variant="caption" color="muted">
          Icon-only buttons require an explicit `aria-label` on each child — the group label is not
          enough for screen readers to identify individual actions.
        </Text>
        <div className={styles.row}>
