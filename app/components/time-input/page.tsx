    ...
    <main className={styles.page}>
      <header className={styles.header}>
        ...
        <Text variant="lead" color="muted">
          ...
          implementation per WAI-ARIA APG. Supports 12h/24h display via <code>hourCycle</code>,
          optional seconds, minute step, and min/max bounds. Emits 24h ISO string regardless of
          display cycle.
        </Text>
        <Inline gap={2} wrap>
      ...
      <section className={styles.section} aria-label="Basic 24h time">
        ...
        <Text variant="body" color="muted">
          Use ArrowUp/Down to nudge each field, PageUp/Down for ±10h/±15m, type digits directly
          (auto-advances on 2-digit completion). Default locale-derived cycle (en-US baseline = 12h
          on first paint, switches to navigator.language on hydration; pass <code>hourCycle</code>
          explicitly for stable SSR output).
        </Text>
        <div className={styles.demo}>
          <TimeInput label="Start time" defaultValue="08:30" hourCycle="24h" />
        </div>
      </section>
      ...
      <section className={styles.section} aria-label="12h with AM/PM">
        ...
        <Text variant="body" color="muted">
          Hour field shows 1-12. AM/PM <code>role=&quot;switch&quot;</code> toggle at logical-end.
          Press Space/Enter on the toggle to flip period. Emitted value is always 24h ISO.
        </Text>
        <div className={styles.demo}>
          <TimeInput
            label="Meeting time"
      ...
      <section className={styles.section} aria-label="With seconds">
        ...
        <Text variant="body" color="muted">
          <code>withSeconds</code> adds a third spinbutton. Useful for timestamps, race times,
          scheduled jobs.
        </Text>
        <div className={styles.demo}>
          <TimeInput
      ...
      <section className={styles.section} aria-label="Step 15 minutes">
        ...
        <Text variant="body" color="muted">
          ArrowUp/Down on the minute field increments by 15. Useful for appointment slots. Direct
          typing still accepts arbitrary values.
        </Text>
        <div className={styles.demo}>
          <TimeInput
            label="Slot"
      ...
      <section className={styles.section} aria-label="Min/max constrained">
        ...
        <Text variant="body" color="muted">
          <code>min=&quot;09:00&quot;</code>, <code>max=&quot;17:00&quot;</code>. Out-of-range
          values clamp on commit. Home/End jump to field min/max.
        </Text>
        <div className={styles.demo}>
          <TimeInput
            label="Office hours"
      ...
      <section className={styles.section} aria-label="Form integration">
        ...
        <Text variant="body" color="muted">
          When <code>name</code> is set, TimeInput renders a hidden input carrying the 24h ISO.{' '}
          <code>required=true</code> + empty value surfaces native HTML5 <code>:invalid</code> on
          submit.
        </Text>
        <form className={styles.formDemo} onSubmit={handleSubmit} noValidate>
          <TimeInput
            ...
            required
          />
          <TimeInput label="Ends at" name="endsAt" defaultValue="11:30" hourCycle="24h" required />
          <Inline gap={2}>
      ...
      <section className={styles.section}>
        ...
        <Text variant="small" color="secondary">
          <code>showSteppers</code> renders a stacked ↑/↓ pair on the right edge of the input wrap.
          They act on the currently-focused segment (hour / minute / second). Pointer-down
          hold-to-repeat (400ms initial → 80ms repeat) matches native spinbutton browser convention.
          Buttons carry <code>tabIndex=-1</code> — keyboard users keep ArrowUp/Down on the
          spinbuttons themselves with better ergonomics.
        </Text>
        <Inline gap={6} wrap>
          <TimeInput label="24h with steppers" defaultValue="14:30" hourCycle="24h" showSteppers />
          <TimeInput
