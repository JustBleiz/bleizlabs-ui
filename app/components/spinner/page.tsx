...
import {
  ...
  type SpinnerSize,
  type SpinnerColor,
} from '@/components/display/Spinner';
  ...
  return (
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <Heading level={1} size="4xl">Spinner</Heading>
        <p className={styles.intro}>
          Inline loading indicator with 4 sizes, 3 colors. role=&quot;status&quot; with
          hidden screen-reader label. Reduced-motion users get a paused indicator.
        </p>
      </header>

      <section className={styles.demo}>
        <Heading level={2} size="2xl">1. Sizes</Heading>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">2. Colors</Heading>
        <div className={styles.row}>
          {COLORS.map((color) => (
            <div key={color} className={styles.cell}>
              <Spinner color={color} size="md" />
              <Text variant="caption" color="muted">{color}</Text>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">3. Inline with text (color=current)</Heading>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">4. Custom label</Heading>
