    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          Utility atom that renders content visible only to assistive tech.
          Mirrors the <code>sr-only</code> SCSS mixin as a React primitive so
          consumer code can author accessible-name overlays, chart captions,
          and skip-target labels without owning the screen-reader-only CSS
          recipe. Hidden visually (clipped 1×1px) but kept in the
          accessibility tree.
        </p>
      </header>
        ...
        <div className={styles.sectionBody}>
          <div role="img" aria-labelledby="chart-1-label">
            <VisuallyHidden id="chart-1-label">
              Stacked bar chart — 35% revenue brand-coloured, 65% remaining
              neutral.
            </VisuallyHidden>
            <div aria-hidden="true" className={styles.chart} />
          </div>
          <p className={styles.bodyText}>
            Sighted users see the decorative bar; assistive tech reads
            &ldquo;Stacked bar chart …&rdquo; via <code>aria-labelledby</code>.
          </p>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.sectionBody}>
          ...
          <Text>
            The <code>&lt;h2&gt;</code> participates in the document outline
            (skip-to-heading nav works) but renders no visual chrome.
          </Text>
        </div>
      </section>
    </main>
