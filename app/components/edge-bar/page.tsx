    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          ...
          parent. Phase 3 Display atom — server-safe, decorative-by-default
          (<code>aria-hidden=&quot;true&quot;</code>). Reuses Badge&apos;s
          6-color palette. <strong>Parent must set <code>position:
          relative</code></strong> for anchoring to work. Promoted v0.8.1 from
          panel_v2 driving consumers (ProjectCard top-edge accent +
          ServiceCardRow left-edge selection indicator).
        </p>
      </header>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          ...
          (D9 + D28 ratified <code>@raw-px-ok</code> exemption).
        </p>
        <div className={styles.cardRow}>
          <div className={styles.demoCard}>
      ...
      <section className={styles.section}>
        <Heading level={2} size="lg" className={styles.sectionTitle}>
          6. Top-edge accent on Card (ProjectCard pattern)
        </Heading>
        <p className={styles.sectionDescription}>
          Most common driving-consumer pattern. EdgeBar replaces the legacy
          raw <code>&lt;span className=&quot;edge&quot;&gt;</code> markup
          across panel_v2 ProjectCard / ServiceCard.
        </p>
        <div className={styles.demoCard}>
          <EdgeBar position="top" color="success" thickness="lg" />
          <Heading level={3} size="md">
            Project Acme — operational
          </Heading>
          <Text variant="body" color="secondary" className={styles.bodyText}>
      ...
      <section className={styles.section}>
        <Heading level={2} size="lg" className={styles.sectionTitle}>
          7. Left-edge accent on row items (ServiceCardRow pattern)
        </Heading>
        <p className={styles.sectionDescription}>
          Selected / status row indicator. Replaces the legacy raw{' '}
          <code>&lt;span className=&quot;rowLeftEdge&quot;&gt;</code> across
          panel_v2 list rows.
        </p>
