    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          Chronological event-list molecule (Phase 7). Compound flat exports
          per D24: <code>Timeline</code> + <code>TimelineItem</code> +{' '}
          <code>TimelineMarker</code>. Renders semantic <code>{'<ol>/<li>'}</code>{' '}
          + tinted markers + connector spine via CSS{' '}
          <code>::before</code> pseudo-element. Promoted v0.8.2 from
          ActivityFeed driving consumers (BleizOS + panel_v2 + scout-hub).
        </p>
      </header>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          ...
          library (Tabler precedent in driving consumers).
        </p>
        <div className={styles.demoCard}>
          <Timeline>
            <TimelineItem
      ...
      <section className={styles.section}>
        <Heading level={2} size="lg" className={styles.sectionTitle}>
          5. ActivityFeed pattern (driving-consumer mirror)
        </Heading>
        <p className={styles.sectionDescription}>
          Realistic event feed: title row + relative timestamp +
          description. Mirrors BleizOS / panel_v2 ActivityFeed structure
          1:1. Each item composes <code>TimelineItem</code> + custom marker
          + content slots.
        </p>
        <div className={styles.demoCard}>
          <Timeline>
            ...
            >
              ...
              <p className={styles.eventBody}>
                Hydroh2 Project Alpha · production deploy passed all gates.
              </p>
            </TimelineItem>
            <TimelineItem
              tint="warning"
            ...
            >
              ...
              <p className={styles.eventBody}>
                S3 bucket warmtech-prod · upgrade recommended within 14 days.
              </p>
            </TimelineItem>
