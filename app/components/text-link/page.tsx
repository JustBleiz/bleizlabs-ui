  ...
  return (
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <Heading level={1} size="4xl">TextLink</Heading>
        <Text variant="lead" color="secondary">
          Inline atelier link atom. Animated arrow suffix + underline-on-hover.
          Framework-agnostic; `asChild` projects styling onto consumer&apos;s
          Link component (e.g. next/link).
        </Text>
      </header>

      <section className={styles.demo}>
        <Heading level={2} size="2xl">1. Default — anchor with arrow</Heading>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">2. hideArrow — anchor with text only</Heading>
        <div className={styles.frame}>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">3. asChild — Next Link with arrow</Heading>
        <div className={styles.frame}>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">4. asChild + hideArrow — Next Link, no arrow</Heading>
        <div className={styles.frame}>
