  ...
  return (
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>Semantic heading element with decoupled visual size. Six levels, 13 sizes (incl. editorial scale), weight/color/align/asChild.</p>
      </header>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">7. Editorial scale — login asides + form cards</Heading>
        ...
        <div className={styles.col}>
          ...
          <div className={styles.frame}>
            ...
            <Heading level={2} size="form-card-title">Sign in</Heading>
