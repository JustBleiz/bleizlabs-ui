    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          Semantic heading element with decoupled visual size. Six levels, 13 sizes (incl. editorial
          scale), weight/color/align/asChild.
        </p>
      </header>

      <section className={styles.demo}>
        <Heading level={2} size="2xl">
          1. Default size per level
        </Heading>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">
          2. Size override (level=2 with all sizes)
        </Heading>
        <div className={styles.col}>
          {SIZES.map((s) => (
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">
          6. asChild — renders as &lt;a&gt; (linked title)
        </Heading>
        <div className={styles.frame}>
          <Heading level={2} asChild>
            <a href="#example" className={styles.link}>
              This h2 is actually an anchor element
            </a>
          </Heading>
        </div>
      </section>
      ...
      <section className={styles.demo}>
        <Heading level={2} size="2xl">
          7. Editorial scale — login asides + form cards
        </Heading>
        <p className={styles.intro}>
          Three editorial sizes filling gaps in the standard scale. Use <code>hero-editorial</code>{' '}
          for landing/login aside H1s where the full <code>display</code> tier overpowers. Use{' '}
          <code>form-card-title</code> + <code>form-card-subtitle</code> for form-card pairs where
          xl reads too dominant and lg too small.
        </p>

        <div className={styles.col}>
          <div className={styles.frame}>
            <span className={styles.label}>
              level=1 size=&quot;hero-editorial&quot; (login aside H1)
            </span>
          ...
          <div className={styles.frame}>
            ...
            <Heading level={2} size="form-card-title">
              Sign in
            </Heading>
          ...
          <div className={styles.frame}>
            ...
            <Heading level={3} size="form-card-subtitle" color="muted" weight="regular">
              size=&quot;display-md&quot; (max 48px)
            </Heading>
            <Heading level={2} size="display-md">
              Atelier signature.
            </Heading>
            <Heading level={3} size="form-card-subtitle" color="muted" weight="regular">
              size=&quot;hero-editorial&quot; (max 52px)
            </Heading>
            <Heading level={2} size="hero-editorial">
              Atelier signature.
            </Heading>
            <Heading level={3} size="form-card-subtitle" color="muted" weight="regular">
              size=&quot;display&quot; (max 72px)
            </Heading>
