    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          Universal collapsible info card preset. Sister to{' '}
          <code>ZoneCard</code> — adds APG{' '}
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          All ZoneCard props inherited unchanged. <code>rightSlot</code>{' '}
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          Grouped pattern: 2-3 collapsible zones in a vertical Stack, each
          with own icon + tone + summary chip. First zone defaultOpen for
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          ...
          cascade (mirrors ZoneCard contract).
        </p>
        <div className={styles.zoneList}>
          <CollapsibleZoneCard
