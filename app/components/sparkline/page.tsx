...
const escalation30d = [
  4, 6, 3, 5, 8, 7, 9, 12, 10, 8, 11, 13, 15, 14, 12, 16, 18, 17, 15, 19, 21, 20, 23, 22, 25, 28,
  26, 30, 32, 31,
];
    ...
    <main className={styles.page}>
      <header className={styles.header}>
        ...
        <Text color="secondary">
          Tiny inline single-series chart (line + optional filled area) for embedding in{' '}
          <code>&lt;Card&gt;</code>, table cells, KPI tiles, dense dashboards. Strips axes / tooltip
          / keyboard nav — preserves sr-only <code>&lt;table&gt;</code> a11y fallback. Zero external
          deps. Imports math from <code>specialized/_shared/chart-math</code> (shared with LineChart
          + AreaChart).
        </Text>
        <Inline gap={2} wrap>
      ...
      <section className={styles.section} aria-label="Basic">
        ...
        <Text color="secondary">
          Default smooth Catmull-Rom interpolation, brand color, no fill. AT users get the sr-only{' '}
          <code>&lt;table&gt;</code>.
        </Text>
      ...
      <section className={styles.section} aria-label="Area + gradient">
        ...
        <Text color="secondary">
          <code>area</code> + <code>gradient</code> renders the &quot;sparkline / report&quot;
          pattern — series color at peak fading to transparent at the baseline.
        </Text>
        <div className={styles.demo}>
          <div className={styles.spark100}>
            <Sparkline
      ...
      <section className={styles.section} aria-label="KPI lockup">
        ...
        <Text color="secondary">
          Canonical sparkline placement: next to a numeric KPI, providing the &quot;direction
          signal&quot;. Width auto-fills the parent container; consumer sets the height via{' '}
          <code>aspectRatio</code> or explicit <code>style.height</code>.
        </Text>
        <div className={styles.demo}>
          <Inline gap={6} wrap>
      ...
      <section className={styles.section} aria-label="Trend variants">
        ...
        <Text color="secondary">
          Four data shapes side-by-side. Consumer colors each via <code>color</code> prop based on
          its own trend-detection rule (positive / negative / neutral).
        </Text>
        <div className={styles.demo}>
      ...
      <section className={styles.section} aria-label="Linear">
        ...
        <Text color="secondary">
          <code>interpolation=&quot;linear&quot;</code> renders polyline (no curve smoothing).
          Cleaner read for spiky data.
        </Text>
        <div className={styles.demo}>
          <div className={styles.spark100}>
            <Sparkline
      ...
      <section className={styles.section} aria-label="Empty + degenerate">
        ...
        <Text color="secondary">
          Empty array renders default &quot;—&quot; placeholder + empty sr-only table. Single value
          renders horizontal stroke at that value.
        </Text>
        <div className={styles.demo}>
          <Inline gap={6} wrap>
            <div className={styles.spark100}>
      ...
      <section className={styles.section} aria-label="Animation off">
        ...
        <Text color="secondary">
          Disable path-draw + fill fade-in for static report contexts (PDF export, print preview).{' '}
