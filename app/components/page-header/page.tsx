    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          Page-top title section molecule. Composes Heading + Text + Badge
          atoms with optional accent span (char-index slicing on{' '}
          <code>title</code>), subtitle, status badge strip, and right-aligned
          actions slot. Sister to <code>SectionHeader</code> (section-level)
          and <code>DataRow</code> (row-level).
        </p>
      </header>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.sectionBody}>
          <PageHeader
            ...
            subtitle="Katalog partnerów technologicznych z certyfikacją"
            badges={[
