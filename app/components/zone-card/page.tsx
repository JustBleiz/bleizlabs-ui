    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          Universal info card preset (CP9). Renders semantic{' '}
          <code>&lt;section&gt;</code> with optional icon + title +
          subtitle + rightSlot in header, then consumer-bespoke body content
          via children. Server-Component safe (zero client hooks). Promoted
          v0.8.0 from bleizlabs-website panel_v2 driving consumers
          (TechnicalInfraCard 5 zones + ProjectsFinancialOverview 2 wrappers).
        </p>
      </header>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          TechnicalInfraCard pattern: 3+ zones in a vertical Stack, each
          with own icon + title + status chip.
        </p>
        ...
        <div className={styles.zoneList}>
          ...
          >
            <Text variant="small" color="secondary">
              ...
              lists like TechnicalInfraCard&apos;s 5-zone vertical stack.
            </Text>
          </ZoneCard>
        </div>
      </section>
