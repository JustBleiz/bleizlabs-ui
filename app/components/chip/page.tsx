    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.intro}>
          ...
          Promoted v0.5.4 from scout-hub B7 12-status filter row; display
          variant added v0.5.5; touch-target enforcement v0.7.5.
        </p>
      </header>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.sectionBody}>
          ...
          <p className={styles.bodyText}>
            ...
            <code>md</code> (default, panel rows). Both grow to 44×44 minimum
            on coarse pointers per <code>--size-touch-min</code> token (v0.7.5).
          </p>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.sectionBody}>
          ...
          <p className={styles.bodyText}>
            ...
            inside summary surfaces (e.g. ICP scope chips, lead profile bands).
