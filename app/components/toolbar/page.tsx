    ...
    <main className={styles.page}>
      <header className={styles.header}>
        ...
        <Text variant="lead" color="muted">
          Accessible toolbar container per WAI-ARIA APG <code>/toolbar/</code>.
          Lightweight Radix-pattern: ships <code>role=&quot;toolbar&quot;</code> +
          roving tabindex + arrow-key navigation. Composes existing lib
          <code> &lt;Button&gt;</code>, <code>&lt;ToggleGroup&gt;</code>,
          <code> &lt;Separator&gt;</code> directly — no Toolbar.Button compound
          parts. Single tab-stop into the toolbar; arrow keys move within;
          Tab exits.
        </Text>
      </header>
      ...
      <section className={styles.section}>
        ...
        <Text variant="body" color="muted">
          ...
          <code> ToggleGroup type=&quot;multiple&quot;</code> (bold/italic/
          underline) with a vertical <code>Separator</code> and standalone
          ghost <code>Button</code>s.
        </Text>
      ...
      <section className={styles.section}>
        ...
        <Text variant="body" color="muted">
          ...
          <code> orientation=&quot;vertical&quot;</code> swaps keyboard nav
          from Right/Left to Down/Up, and the flex axis switches to column.
        </Text>
        <div className={styles.demo}>
      ...
      <section className={styles.section}>
        ...
        <Text variant="body" color="muted">
          ...
          <code> aria-disabled=&quot;true&quot;</code>) are filtered out of
          the roving sequence. Arrow keys jump over them.
        </Text>
        <div className={styles.demo}>
      ...
      <section className={styles.section}>
        ...
        <Text variant="body" color="muted">
          By default arrow keys wrap around. Set <code>loop=&#123;false&#125;</code> to
          clamp at the ends — useful when toolbar order has linear semantics
      ...
      <section className={styles.section}>
        ...
        <Text variant="body" color="muted">
          With <code>dir=&quot;rtl&quot;</code> in horizontal orientation,
          Right Arrow moves to the PREVIOUS item and Left Arrow to the NEXT
          — matching reading direction. Layout is also visually reversed
          (children appear right-to-left).
        </Text>
        <div className={styles.demo}>
