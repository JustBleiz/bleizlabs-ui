...
// ============================================================================
// AppShell playground — Phase 12 composition preset
// ----------------------------------------------------------------------------
    ...
    <Stack gap={6} className={styles.content}>
      <Stack gap={3}>
        <Heading level={1} size="2xl">
          AppShell — Phase 12 composition preset
        </Heading>
      ...
      <Stack gap={4}>
        ...
        <Text variant="body" color="secondary">
          The bleizos pattern omits the topNav slot entirely (logout lives in
          the Sidebar footer card). The panel pattern adds a topNav with
          breadcrumb + identity pill + actions row. AppShell handles both via
          a single optional slot — consumer chooses by passing or omitting
          `topNav` prop.
        </Text>
      </Stack>
      ...
      <Stack gap={4}>
        ...
        <Text variant="body" color="secondary">
          ...
          Forensic: 2026-05-05 panel + bleizos regression in
          bleizlabs-website required two near-identical fix-ups before this
          preset shipped. Single source of truth here prevents that bug class
          entirely.
        </Text>
      </Stack>
